...
// Robot & board parameters (All dimensions should match python)
const float STEPS_PER_MM = (STEPS_PER_REVOLUTION*16) / (0.5 * PI * 25.4);  
const float WHITEBOARD_WIDTH = 509;
const float WHITEBOARD_HEIGHT = 864;

const float DRAW_WIDTH_MM = 254;
const float DRAW_HEIGHT_MM = 241;

const float OFFSET_X_MM = 127;  
const float OFFSET_Y_MM = 419;  

// Initial position
const float START_X_MM = 254;                      
const float START_Y_MM = 660;   
...
void setup() {
  ...
  // Calculate initial string lengths and steps
